...
public class StockTaskService extends GcmTaskService {
                ...
                try {
                    ...
                    if (batchOperations != null) {
                        ...
                        new Handler(Looper.getMainLooper()).post(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(mContext,mContext.getString(R.string.invalid_input_toast), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
    ...
    void updateWidget(){
        Intent dataUpdatedIntent = new Intent(WidgetProvider.ACTION_WIDGET_UPDATE)
